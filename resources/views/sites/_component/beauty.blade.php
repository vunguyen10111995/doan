...
<section class="banner">
    <div>
        <img src="https://img.jamja.vn/jamja-prod/gcs_full_jamja-foodhouse-web-banner-large-leaderboard-2x-2280x282-2018-06-19-060906.png" width="100%" height="50%" alt="">
    </div>
</section>
<!-- TOP DEALS -->
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="sectionTitle">
                    <h2><span class="lightBg">Beauty</span></h2>
                </div>
            </div>
        </div>
